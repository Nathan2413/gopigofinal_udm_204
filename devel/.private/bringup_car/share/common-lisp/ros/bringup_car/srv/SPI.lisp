...
(cl:defmethod cl:initialize-instance :after ((m <SPI-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SPI-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bringup_car-srv:<SPI-request> is deprecated: use bringup_car-srv:SPI-request instead.")))

(cl:ensure-generic-function 'data_out-val :lambda-list '(m))
(cl:defmethod data_out-val ((m <SPI-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bringup_car-srv:data_out-val is deprecated.  Use bringup_car-srv:data_out instead.")
  (data_out m))
...
(cl:defmethod cl:initialize-instance :after ((m <SPI-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SPI-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bringup_car-srv:<SPI-response> is deprecated: use bringup_car-srv:SPI-response instead.")))

(cl:ensure-generic-function 'data_in-val :lambda-list '(m))
(cl:defmethod data_in-val ((m <SPI-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bringup_car-srv:data_in-val is deprecated.  Use bringup_car-srv:data_in instead.")
  (data_in m))
