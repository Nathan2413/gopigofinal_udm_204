...
(cl:defmethod cl:initialize-instance :after ((m <MotorStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bringup_car-msg:<MotorStatus> is deprecated: use bringup_car-msg:MotorStatus instead.")))

(cl:ensure-generic-function 'low_voltage-val :lambda-list '(m))
(cl:defmethod low_voltage-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bringup_car-msg:low_voltage-val is deprecated.  Use bringup_car-msg:low_voltage instead.")
  (low_voltage m))

(cl:ensure-generic-function 'overloaded-val :lambda-list '(m))
(cl:defmethod overloaded-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bringup_car-msg:overloaded-val is deprecated.  Use bringup_car-msg:overloaded instead.")
  (overloaded m))

(cl:ensure-generic-function 'power-val :lambda-list '(m))
(cl:defmethod power-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bringup_car-msg:power-val is deprecated.  Use bringup_car-msg:power instead.")
  (power m))

(cl:ensure-generic-function 'encoder-val :lambda-list '(m))
(cl:defmethod encoder-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bringup_car-msg:encoder-val is deprecated.  Use bringup_car-msg:encoder instead.")
  (encoder m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bringup_car-msg:speed-val is deprecated.  Use bringup_car-msg:speed instead.")
  (speed m))
