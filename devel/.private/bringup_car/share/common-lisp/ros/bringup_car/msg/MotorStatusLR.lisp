...
(cl:defclass <MotorStatusLR> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (left
    :reader left
    :initarg :left
    :type bringup_car-msg:MotorStatus
    :initform (cl:make-instance 'bringup_car-msg:MotorStatus))
   (right
    :reader right
    :initarg :right
    :type bringup_car-msg:MotorStatus
...
(cl:defmethod cl:initialize-instance :after ((m <MotorStatusLR>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorStatusLR)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bringup_car-msg:<MotorStatusLR> is deprecated: use bringup_car-msg:MotorStatusLR instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MotorStatusLR>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bringup_car-msg:header-val is deprecated.  Use bringup_car-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'left-val :lambda-list '(m))
(cl:defmethod left-val ((m <MotorStatusLR>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bringup_car-msg:left-val is deprecated.  Use bringup_car-msg:left instead.")
  (left m))

(cl:ensure-generic-function 'right-val :lambda-list '(m))
(cl:defmethod right-val ((m <MotorStatusLR>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bringup_car-msg:right-val is deprecated.  Use bringup_car-msg:right instead.")
  (right m))
